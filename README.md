...
第 4 页已加入 Brief 截图，并通过「BRIEF MOCKUP」链接到飞书示例；第 5 页以 40% / 30% / 20% / 10% 比例条展示内容测试组合，并按产品生活场景、产品手持使用、人脸功效、定制组合顺序加入四张案例图片。其余业务图片与截图为示意占位。使用相对图片路径时，需将图片一起保存或部署；继续使用内嵌图片可保留单文件离线能力。
